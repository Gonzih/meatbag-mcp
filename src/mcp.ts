...
import { postRequest, pollResponse } from "./mcp-core";
...
async function requestHumanInput(
  ...
  const requestId = await postRequest(SERVICE_URL, question, image_path);
  return pollResponse(SERVICE_URL, requestId);
}
